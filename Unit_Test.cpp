...
const EM::FileName FILE_WITH_HTML_10Q_NO_USABLE_ANCHORS{"/vol_DA/SEC/Archives/edgar/data/1046672/0001102624-13-001243.txt"};
const EM::FileName FILE_WITH_HTML_10Q_NO_USABLE_ANCHORS2{"/vol_DA/SEC/Archives/edgar/data/841360/0001086380-13-000031.txt"};
const EM::FileName FILE_WITH_HTML_10Q_NO_USABLE_ANCHORS3{"/vol_DA/SEC/Archives/edgar/data/949268/0001137171-09-000933.txt"};
...
const EM::FileName FILE_WITH_HTML_10Q_PROBLEM_REGEX1{"/vol_DA/SEC/Archives/edgar/data/1377936/0001104659-13-075719.txt"};
...
//const EM::FileName BAD_FILE1{"/vol_DA/SEC/SEC_forms/1000228/10-K/0001000228-11-000014.txt"};
//const EM::FileName BAD_FILE2{"/vol_DA/SEC/SEC_forms/1000180/10-K/0001000180-16-000068.txt"};
//const EM::FileName BAD_FILE3{"/vol_DA/SEC/SEC_forms/1000697/10-K/0000950123-11-018381.txt"};
//const EM::FileName NO_SHARES_OUT{"/vol_DA/SEC/SEC_forms/1023453/10-K/0001144204-12-017368.txt"};
//const EM::FileName TEST_FILE_LIST{"./list_with_bad_file.txt"};
//const EM::FileName MISSING_VALUES1_10K{"/vol_DA/SEC/SEC_forms/1004980/10-K/0001193125-12-065537.txt"};
//const EM::FileName MISSING_VALUES2_10K{"/vol_DA/SEC/SEC_forms/1002638/10-K/0001193125-09-179839.txt"};
...
const EM::FileName FILE_WITH_SHARES_AND_VALUE{"/vol_DA/SEC/Archives/edgar/html/0000004127/0000004127-15-000037.txt_fy1510k1022015.htm"};
const EM::FileName FILE_WITH_NO_POSSIBLES{"/vol_DA/SEC/Archives/edgar/html/0001609711/0001609711-19-000012.txt_a201810-kx10kdocument.htm"};
const EM::FileName FILE_WITH_SHARES_BEFORE_YESNO{"/vol_KUtil2/SEC_exports/html/0000019617/10-K/0000950123-04-002022.txt_y94051e10vk.htm"};
const EM::FileName FILE_WITH_SHARES_AFTER_CONTENTS{"/vol_KUtil2/SEC_exports/html/0000000020/10-K/0000893220-05-000728.txt_w06061e10vk.htm"};
const EM::FileName FILE_WITH_SHARE_VALUE_NO_DOLLAR_SIGN{"/vol_KUtil2/SEC_exports/html/0001326160/10-K/0001326160-14-000003.txt_form10k.htm"};
const EM::FileName FILE_WITH_XBRL_INSIDE_HTM_DOCUMENT{"/vol_KUtil2/SEC_exports/html/0000029905/10-K/0000029905-19-000019.txt_wfx-20181231.htm"};
...
TEST_F(ExportHTML, VerifyExportAll_10Q)
{
    ...
    std::for_each(fs::recursive_directory_iterator(SEC_DIRECTORY.get()), fs::recursive_directory_iterator(), export_file);
